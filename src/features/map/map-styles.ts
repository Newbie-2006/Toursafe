// Minimal, elegant Google Maps styles for light + dark to match the brand.
export const LIGHT_MAP_STYLE: google.maps.MapTypeStyle[] = [
  ...
  { featureType: "poi.park", elementType: "geometry", stylers: [{ color: "#dfe9e0" }] },
  { featureType: "road", elementType: "geometry", stylers: [{ color: "#ffffff" }] },
  { featureType: "road", elementType: "labels.text.fill", stylers: [{ color: "#9ca3af" }] },
  { featureType: "road.highway", elementType: "geometry", stylers: [{ color: "#efe7d8" }] },
  { featureType: "transit", stylers: [{ visibility: "off" }] },
  { featureType: "water", elementType: "geometry", stylers: [{ color: "#c7dbe0" }] },
];
...
export const DARK_MAP_STYLE: google.maps.MapTypeStyle[] = [
  ...
  { featureType: "administrative", elementType: "geometry", stylers: [{ visibility: "off" }] },
  { featureType: "poi", stylers: [{ visibility: "off" }] },
  { featureType: "poi.park", elementType: "geometry", stylers: [{ color: "#16241d" }] },
  { featureType: "road", elementType: "geometry", stylers: [{ color: "#20242c" }] },
  { featureType: "road", elementType: "labels.text.fill", stylers: [{ color: "#6b7280" }] },
  { featureType: "road.highway", elementType: "geometry", stylers: [{ color: "#2a2e35" }] },
  { featureType: "transit", stylers: [{ visibility: "off" }] },
